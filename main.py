...
class Quiz:
    ...
    # COLORS:
    # '#D7E8F6' = color of the buttons
    # '#2B8FE5' = color of the text within buttons
    # '#8087CA' = color of line on top

    
		# The first button is the Next button to move to the
		# next Question
		next_button = Button(gui, text="Next",command=self.next_btn,
		width=10,bg="#D7E8F6",fg="#2B8FE5",font=("ariel",16,"bold"))
		...
		width=5,bg="#D7E8F6", fg="#2B8FE5",font=("ariel",16," bold"))
	...
	def display_title(self):
		...
		title = Label(gui, text="Are you an INFJ?",
		width=50, bg="#8087CA",fg="white", font=("ariel", 20, "bold"))
...
gui.title("INFJ Personality Quiz")
